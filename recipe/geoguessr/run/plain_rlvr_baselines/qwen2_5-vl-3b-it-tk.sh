...
export SWANLAB_RUN_ID=0v3t6aumgwj97wt833nc0
...
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/Qwen/Qwen2.5-VL-3B-Instruct"
MODEL="qwen2_5_vl_3b-it-tk-baseline"
