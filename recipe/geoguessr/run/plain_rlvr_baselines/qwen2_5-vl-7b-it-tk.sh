...
export SWANLAB_RUN_ID=etzpeg590ko2gsn4nc798
...
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/Qwen/Qwen2.5-VL-7B-Instruct"
MODEL="qwen2_5_vl_7b-it-tk-baseline"
