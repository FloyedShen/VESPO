...
export SWANLAB_RUN_ID=zdp95nul1mzgvcikdwd4a
...
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/Qwen/Qwen3-VL-4B-Instruct"
MODEL="qwen3_vl_4b-it-baseline"
