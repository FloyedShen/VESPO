...
export SWANLAB_RUN_ID=u4d0yeu5yn8ghiqwfif0x
...
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/Qwen/Qwen3-VL-4B-Thinking"
MODEL="qwen3_vl_4b-tk-baseline"
