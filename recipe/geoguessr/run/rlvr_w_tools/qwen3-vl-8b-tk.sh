...
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/Qwen/Qwen3-VL-8B-Thinking"
MODEL="qwen3_vl_8b-tk-tools-all"
...
python3 -m verl.trainer.main_ppo \
    --config-path "$PROJECT_DIR/recipe/geoguessr/config" \
    ...
    actor_rollout_ref.rollout.multi_turn.tool_config_path=recipe/geoguessr/config/geoguessr_service_tools_config.yaml \
