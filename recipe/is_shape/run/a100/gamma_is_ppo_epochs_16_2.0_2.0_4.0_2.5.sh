...
OBJECT="math"
DATASET="dapo_math"
MODEL_FULL="/mnt/data/modelscope/models/nv-community/OpenMath-Nemotron-1.5B"
MODEL="openmath-nemotron-1b5"
BATCH_SIZE=256
MINI_BATCH=256
PPO_EPOCHS=16
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}"

# Data Configuration
DATA_ROOT="/mnt/home/floyed/verl/recipe/is_shape/data"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    trainer.default_local_dir=/mnt/home/floyed/verl/checkpoints/$PROJECT_NAME/$EXP_NAME \
    trainer.validation_data_dir=/mnt/home/floyed/verl/validation_outputs/$PROJECT_NAME/$EXP_NAME/$TIMESTAMP \
