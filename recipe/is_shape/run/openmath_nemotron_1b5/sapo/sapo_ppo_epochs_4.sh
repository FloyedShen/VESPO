...
# ============================================================================
# SAPO: Smoothed Advantage Policy Optimization
#
# Key features:
#   - Soft trust region via gating function: gate(r,τ) = sigmoid(τ*(r-1)) * (4/τ)
...
OBJECT="math"
DATASET="deepscaler"
MODEL_FULL="/mnt/tidal-alsh-hilab/usr/shenguobin/modelscope/nv-community/OpenMath-Nemotron-1.5B"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.sapo.tau_pos=1.0 \
    +actor_rollout_ref.actor.policy_loss.sapo.tau_neg=1.05 \
