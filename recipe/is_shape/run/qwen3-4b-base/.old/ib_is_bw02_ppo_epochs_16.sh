...
# ============================================================================
# IB-IS with Bandwidth = 0.2 (More Conservative)
#
# bandwidth = 0.2 corresponds to w range approximately [0.82, 1.22]
# This is more conservative, closer to SFT behavior
# Suitable for early training or when distribution shift is large
# ============================================================================
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.ib_is.bandwidth=0.2 \
