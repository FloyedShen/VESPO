...
# ============================================================================
# IS Reshape: batch_size=256, ppo_epochs=16
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.is_reshape.rho_min=0.5 \
    ...
    +actor_rollout_ref.actor.policy_loss.is_reshape.clip_threshold=10.0 \
