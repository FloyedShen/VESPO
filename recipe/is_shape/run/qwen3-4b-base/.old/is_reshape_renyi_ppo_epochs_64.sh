...
# ============================================================================
# IS Reshape Rényi: batch_size=256, ppo_epochs=64
# Data Reuse: Each batch is trained 64 times
# ============================================================================

TIMESTAMP=$(date +%Y-%m-%d_%H-%M-%S)

ALGO="is_reshape_renyi"
OBJECT="math"
DATASET="deepscaler"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=is_reshape_renyi \
    ...
    +actor_rollout_ref.actor.policy_loss.is_reshape_renyi.clip_threshold=10.0 \
