...
# ============================================================================
# IS Reshape Symmetric: Adaptive γ with symmetric constraint around 1
#
# Key features:
#   - γ+ computed using ESS-based formula (same as v7)
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=is_reshape_sym \
    +actor_rollout_ref.actor.policy_loss.is_reshape_sym.rho_min=0.5 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_sym.gamma_min=0.05 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_sym.gamma_max=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_sym.clip_weight=true \
    +actor_rollout_ref.actor.policy_loss.is_reshape_sym.clip_threshold=10.0 \
