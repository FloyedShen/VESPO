...
# ============================================================================
# IS Reshape v4: batch_size=256, ppo_epochs=16
# Reward-modulated trust region with SAPO-style soft boundary
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=is_reshape_v4 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.tau=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.beta=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.gamma_min=0.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.gamma_max=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.clip_weight=false \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v4.clip_threshold=10.0 \
