...
# ============================================================================
# IS Reshape v5: batch_size=256, ppo_epochs=16
# Bias-Variance motivated trust region with correctness-adaptive γ
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=is_reshape_v5 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.tau_h=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.tau_c=1.0 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.gamma_base=0.1 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.gamma_max=0.9 \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.clip_weight=false \
    +actor_rollout_ref.actor.policy_loss.is_reshape_v5.clip_threshold=10.0 \
