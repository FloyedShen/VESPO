...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_static"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.cauchy_is.lambda_base=1.0 \
    ...
    +actor_rollout_ref.actor.policy_loss.cauchy_is.lambda_max=50.0 \
