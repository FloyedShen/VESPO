...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_1.0_0.05_4.0_2.5"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.gamma_is.k_pos=0.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_pos=0.05 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.k_neg=4.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_neg=2.5 \
