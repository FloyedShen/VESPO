...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_1.0_0.5_2.0_1.5"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.gamma_is.k_pos=1.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_pos=0.5 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.k_neg=2.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_neg=1.5 \
