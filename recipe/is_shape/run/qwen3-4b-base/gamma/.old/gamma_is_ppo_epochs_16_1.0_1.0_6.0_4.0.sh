...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_1.0_1.0_6.0_4.0"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_pos=1.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.k_neg=6.0 \
    +actor_rollout_ref.actor.policy_loss.gamma_is.lambda_neg=4.0 \
