...
# ============================================================================
#
# Experiment Configuration: G36 - Ramp_Wall
# Description: 
# k_pos=2.0, lambda_pos=2.5, peak=0.8, k_neg=1.5, lambda_neg=0.2
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G36"
