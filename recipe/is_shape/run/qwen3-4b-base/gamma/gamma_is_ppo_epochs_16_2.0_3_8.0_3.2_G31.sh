...
# ============================================================================
#
# Experiment Configuration: G31 - Conservative
# Description: 极保守: Pos深锚 + Neg究极左侧截断
# k_pos=2.0, lambda_pos=3, peak=0.67, k_neg=8.0, lambda_neg=3.2
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G31"
