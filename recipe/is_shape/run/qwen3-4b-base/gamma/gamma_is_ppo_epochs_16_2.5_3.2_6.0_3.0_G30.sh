...
# ============================================================================
#
# Experiment Configuration: G30 - Left_Anchor
# Description: 强锚定: Pos强力左移限制探索
# k_pos=2.5, lambda_pos=3.2, peak=0.78, k_neg=6.0, lambda_neg=3.0
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G30"
