...
# ============================================================================
#
# Experiment Configuration: G26 - Stable_Tight
# Description: G14改良: Pos微左移收紧 + Neg标准铁壁
# k_pos=2.7, lambda_pos=3.0, peak=0.9, k_neg=6.0, lambda_neg=3.0
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G26"
