...
# ============================================================================
#
# Experiment Configuration: G29 - Precise_Wall
# Description: 高精铁壁: Pos高精(k=3) + Neg高阶宽域
# k_pos=3.0, lambda_pos=3.0, peak=1.0, k_neg=6.0, lambda_neg=2.4
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G29"
