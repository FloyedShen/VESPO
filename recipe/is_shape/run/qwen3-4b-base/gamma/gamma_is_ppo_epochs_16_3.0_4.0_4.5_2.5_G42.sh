...
# ============================================================================
#
# Experiment Configuration: G42 - Urgent_Teach
# Description: 
# k_pos=3.0, lambda_pos=4.0, peak=0.75, k_neg=4.5, lambda_neg=2.5
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G42"
