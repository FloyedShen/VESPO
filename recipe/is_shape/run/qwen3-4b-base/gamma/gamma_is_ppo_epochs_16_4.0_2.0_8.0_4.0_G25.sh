...
# ============================================================================
#
# Experiment Configuration: G25 - Box_Shape
# Description: 
# k_pos=4.0, lambda_pos=2.0, peak=2.0, k_neg=8.0, lambda_neg=4.0
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G25"
