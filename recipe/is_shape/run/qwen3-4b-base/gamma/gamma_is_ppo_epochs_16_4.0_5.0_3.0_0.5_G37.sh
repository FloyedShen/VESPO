...
# ============================================================================
#
# Experiment Configuration: G37 - Heavy_Anchor
# Description: 
# k_pos=4.0, lambda_pos=5.0, peak=0.8, k_neg=3.0, lambda_neg=0.5
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G37"
