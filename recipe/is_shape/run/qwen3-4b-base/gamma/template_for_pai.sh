...
# ============================================================================
#
# Experiment Configuration: G19 - Wild
# Description: 模拟 PPO 的'平顶'感
# k_pos=4.0, lambda_pos=3.2, peak=1.25, k_neg=4.0, lambda_neg=4.0
# ============================================================================
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_G19"

# Data Configuration
DATA_ROOT="/diancpfs/user/guobin/verl/recipe/is_shape/data"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    trainer.default_local_dir=/diancpfs/user/guobin/verl/checkpoints/$PROJECT_NAME/$EXP_NAME \
    trainer.validation_data_dir=/diancpfs/user/guobin/verl/validation_outputs/$PROJECT_NAME/$EXP_NAME/$TIMESTAMP \
