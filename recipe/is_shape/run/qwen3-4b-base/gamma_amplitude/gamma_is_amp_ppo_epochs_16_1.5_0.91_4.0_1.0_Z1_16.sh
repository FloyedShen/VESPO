...
# ============================================================================
#
# Experiment Configuration: Z1_16 - G2_Revival
# Description: 
# k_pos=1.5, lambda_pos=0.91, peak=1.64, k_neg=4.0, lambda_neg=1.0
# ============================================================================

TIMESTAMP=$(date +%Y-%m-%d_%H-%M-%S)

ALGO="gamma_is_adaptive"
OBJECT="math"
DATASET="dapo_math"
...
EXP_NAME="${ALGO}_${OBJECT}_${DATASET}_${MODEL}_ppo_epochs_${PPO_EPOCHS}_${K_POS}_${LAMBDA_POS}_${K_NEG}_${LAMBDA_NEG}_Z1_16"
...
python3 -u -m recipe.is_shape.code.main_ppo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode=gamma_is_adaptive \
